...
public class App {
	...
	public static void main(String[] args) {
		...
		// 컨트롤러 객체 생성
		app = new PCController(LoginView.getInstance(), CusManager.getInstance(), ProdManager.getInstance(),
				GUIView.getInstance(), new AdminView(), new SignUpView(), new C_login(), new C_SignUp(),
				new C_ProdManager(), new PCChatData(), new PCChatData());
